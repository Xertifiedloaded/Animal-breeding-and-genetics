    ...
    <div className=" bg-gray-100 p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2">
        <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4">Number of Responses</h2>
          <p className="text-2xl sm:text-3xl font-bold text-indigo-600">{responsesCount}</p>
        </div>
        <div className="bg-white shadow-lg rounded-lg p-4 sm:p-6">
          <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4">Number of Admins</h2>
